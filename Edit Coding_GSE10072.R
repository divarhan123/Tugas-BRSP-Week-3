...
# write.csv(): menyimpan hasil analisis 50 top genes ke file CSV
write.csv(top50, "Hasil_50topgenes_DEG.csv")

message("Analisis selesai. File hasil 50 top genes telah disimpan.")
